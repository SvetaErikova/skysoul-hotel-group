            ...
            action={
              <>
                <Button type="filled"
                        ...
                        color="primary">Задать свой вопрос</Button>
                <Button type="outlined"
                        link={"/faq.html/"}
                        color="secondary"
                        dark={true}
                        icon={'icon-arrow-right'}>Все вопросы</Button>
              </>
            }
          ></Block_Head>
        }
        ...
        <div className="accordion">
          ...
          <div className="accordion--content">
            <div className="is_cascade">
              ...
              <ul>
                <li>Пользование оборудованием на пляже и у бассейна (шезлонг, полотенце, зонт);</li>
                <li>Посещение СПА;</li>
                <li>Посещение Детского клуба;</li>
                <li>Посещение коворкинга;</li>
                <li>Посещение тренажерного зала;</li>
                <li>Комплектация номера.</li>
              </ul>
            </div>
          </div>
        </div>
