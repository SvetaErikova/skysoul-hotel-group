		...
		var n = (function () {
			...
			return (
				(t.parseDateTime = function (e, i, n) {
					if (
						(void 0 === i && (i = "YYYY-MM-DD"), void 0 === n && (n = "en-US"), !e)
					)
						return new Date(NaN);
			...
			h = (function (t) {
				...
				return (
					...
					(e.prototype.shouldCheckLockDays = function () {
						return (
							this.options.disallowLockDaysInRange && 2 === this.datePicked.length
						);
					}),
									...
									if ((this.emit("before:click", e), this.preventClick))
										...
										if (e.classList.contains(l.dayItem)) {
											...
											if (
												...
												(this.datePicked[this.datePicked.length] = new a.DateTime(
													e.dataset.time,
												)),
										...
										e.classList.contains(l.buttonCancel) &&
											(t.preventDefault(), this.hide(), this.emit("button:cancel")),
					...
					(e.prototype.onMouseEnter = function (t) {
						...
						if (this.isDayItem(i) && this.shouldAllowMouseEnter(i)) {
							...
							var n = this.ui.querySelector(
									"." + l.dayItem + '[data-time="' + this.datePicked[0].getTime() + '"]',
								),
			...
			c = (function (t) {
				...
				return (
					...
					(e.prototype.render = function () {
						...
						if (
							((this.ui.innerHTML = ""), e.appendChild(i), this.options.resetButton)
						) {
							var h = void 0;
					...
					(e.prototype.renderMonth = function (t, e) {
								...
								(u.value = String(d)),
									...
									(u.disabled =
										(this.options.minDate &&
											f.isBefore(new r.DateTime(this.options.minDate), "month")) ||
										(this.options.maxDate &&
											f.isAfter(new r.DateTime(this.options.maxDate), "month"))),
						...
						if (this.options.dropdowns.years) {
							...
							for (d = y; d >= v; d -= 1) {
								...
								(u.value = String(d)),
									...
									(u.disabled =
										(this.options.minDate &&
											b.isBefore(new r.DateTime(this.options.minDate), "year")) ||
										(this.options.maxDate &&
						...
						(x.type = "button"),
							...
							this.options.maxDate &&
								n.isSameOrAfter(new r.DateTime(this.options.maxDate), "month") &&
					...
					(e.prototype.renderFooter = function () {
						...
						if (
							...
							(1 === this.datePicked.length &&
								t.querySelector("." + a.buttonApply).setAttribute("disabled", ""),
							2 === this.datePicked.length)
						) {
				...
				function i(t) {
					e.isMouseDown
						...
						: this.options.inlineMode ||
							...
							this.ui
								.querySelector(
									'[tabindex="'.concat(e.options.keyboardnav.firstTabIndex, '"]'),
								)
								.focus());
				}
				function a(e) {
			...
			return (
				...
				(n.i = function (e, t, r) {
					...
					for (var s = 0; s < e.length; s++) {
						var c = [].concat(e[s]);
						(r && a[c[0]]) ||
							(t && (c[2] ? (c[2] = "".concat(t, " and ").concat(c[2])) : (c[2] = t)),
							n.push(c));
					}
				}),
				n
					...
					t.customRanges =
						...
						o(
							...
							(function (e) {
								var n = e.clone();
								return (
									n.setDate(1), [n, new Date(e.getFullYear(), e.getMonth() + 1, 0)]
								);
							})(i),
						),
						o(
				...
				e.on("before:show", function () {
					...
					e.on("render:day", function (t) {
						...
						n
							...
							: r && e.preMultipleDates.length >= r && t.classList.add("is-locked");
					}),
